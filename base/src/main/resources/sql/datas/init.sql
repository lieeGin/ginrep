...
-- 初始化角色和菜单关系
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('6', '1', '1', '2');
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('7', '1', '2', '1');
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('8', '1', '3', '2');
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('9', '1', '4', '2');
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('12', '1', '9', '2');
INSERT INTO  `sys_role_menu` (`id`, `role_id`, `menu_id`, `auth_level`) VALUES ('13', '1', '10', '2');
